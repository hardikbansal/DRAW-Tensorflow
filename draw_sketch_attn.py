...
class Draw():
	def initialize(self):
		...
		self.tensorboard_dir = "./output/draw_attn_sketch/tensorboard"
		self.check_dir = "./output/draw_attn_sketch/checkpoints"
		self.images_dir = "./output/draw_attn_sketch/imgs"
	...
	def train(self):
		...
		with tf.Session() as sess:
			...
			for epoch in range(0,self.max_epoch):
				...
				for itr in range(0,int(10000/self.batch_size)):
